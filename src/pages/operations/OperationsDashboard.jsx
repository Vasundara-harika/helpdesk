...
export default function OperationsDashboard() {
  return (
    <div className="space-y-8">
      <h2 className="text-2xl font-bold text-[#55D6C2]">Operations Team Dashboard</h2>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {["Pending Approvals", "Resolved Tickets", "Performance Score"].map((title, i) => (
          <motion.div
            key={i}
          ...
          >
            <h3 className="text-lg font-semibold text-[#55D6C2] mb-2">{title}</h3>
