// ✅ src/pages/operations/TicketApproval.jsx
import { useState, useEffect } from "react";
import { FaSearch, FaStar, FaTimes, FaCheck, FaTimesCircle } from "react-icons/fa";
...
export default function TicketApproval() {
  ...
  const assigneeOptions = ["John Doe", "Jane Smith", "Alice Brown", "Mark White"];
            ...
            {filteredTickets.length === 0 ? (
              ...
              filteredTickets.map((ticket) => (
                ...
                >
                  ...
                  <td className="p-3 flex gap-2 text-green-600">
                    <FaCheck className="cursor-pointer hover:text-green-800" />
                    <FaTimesCircle className="cursor-pointer text-red-500 hover:text-red-700" />
                  </td>
                </tr>
              ))
            )}
